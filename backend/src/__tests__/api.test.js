...
const mockPapers = [
  {
    ...
    summary: 'New techniques improve language model performance.',
    keyTakeaway: 'Key takeaway: Better efficiency.',
    tags: ['LLM', 'Efficiency'],
  ...
  },
  {
    ...
    summary: 'A new vision transformer that beats benchmarks.',
    keyTakeaway: 'Key takeaway: State-of-the-art accuracy.',
  ...
  },
  {
    ...
    summary: 'New RL algorithm for robot control.',
    keyTakeaway: 'Key takeaway: 10x faster training.',
